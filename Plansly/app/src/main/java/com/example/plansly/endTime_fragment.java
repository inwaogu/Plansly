...
public class endTime_fragment extends DialogFragment {
    private String TAG = "endTimeFragment";
    private AlertDialog.Builder builder;
    private View endTimeFragmentView;
    ...
    {
        void sendEndTime(String hour, String minutes, String timeZone);
    }

    public static timeOnClickInterface timeInterface;


    public endTime_fragment() {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        endTimeFragmentView = (View) inflater.inflate(R.layout.event_end_time_fragment_layout,null);

        builder.setView(endTimeFragmentView);

        //Get widgets reference from xml layout
        NumberPicker hourPicker = (NumberPicker) endTimeFragmentView.findViewById(R.id.hourPicker);
        NumberPicker minutePicker = (NumberPicker) endTimeFragmentView.findViewById(R.id.minutePicker);
        NumberPicker timeZonePicker = (NumberPicker) endTimeFragmentView.findViewById(R.id.timeZonePicker);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.event_end_time_fragment_layout, container, false);
    }
