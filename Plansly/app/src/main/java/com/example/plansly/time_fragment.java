...
public class time_fragment extends DialogFragment {

    private String TAG = "timeFragment";
    private AlertDialog.Builder builder;
    private View timeFragmentView;
    ...
    {
        void sendTime(String hour, String minutes, String timeZone);
    }
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        timeFragmentView = (View) inflater.inflate(R.layout.time_fragment_layout,null);

        builder.setView(timeFragmentView);

        //Get widgets reference from xml layout
        NumberPicker hourPicker = (NumberPicker) timeFragmentView.findViewById(R.id.hourPicker);
        NumberPicker minutePicker = (NumberPicker) timeFragmentView.findViewById(R.id.minutePicker);
        NumberPicker timeZonePicker = (NumberPicker) timeFragmentView.findViewById(R.id.timeZonePicker);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.time_fragment_layout, container, false);
    }
